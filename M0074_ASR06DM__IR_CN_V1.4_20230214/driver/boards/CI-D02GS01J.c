...
{
    dpmu_set_io_reuse(PA6,FIRST_FUNCTION); /*gpio function*/
    dpmu_set_io_direction(PA6,DPMU_IO_DIRECTION_OUTPUT);
    gpio_set_output_mode(PA, pin_6);
    gpio_set_output_level_single(PA, pin_6, 0);
}
...
{
     dpmu_set_io_reuse(PA6,FIFTH_FUNCTION);/*pwm pad enable*/
}
...
void pad_config_for_night_light(void)
{
    ...
    dpmu_set_io_reuse(PA6,FIFTH_FUNCTION);
