...
// volume set
#ifndef VOLUME_MAX
#define VOLUME_MAX                      5       //voice play max volume level
#endif
#ifndef VOLUME_MID
...
#define CICWSL_TOTAL_TEMPLATE                9 //可存储模板数量
#endif
...
#define COPYRIGHT_VERIFICATION          1 //1：使能flash加密校验，用于防止flash拷贝。需要在lds文件增加ROM段大小。0：禁止flash加密校验
#endif
